...
def main(arg):
    global mfcc, chroma, energy, brightness, hcdf, red300;
    ...
    red300 = pickle.load(open('red300.p', 'rb'))
    ...
    featureCombos = []
    for i in range(5):
        featureCombos += list(itertools.combinations([chroma, energy, brightness, red300], i+1));
    outcomes = {}
