...
def plot_confusion_matrix(cm, title='Confusion matrix', cmap=plt.cm.gist_heat):
    ...
    plt.xticks(tick_marks, ['astro', 'cond', 'cs', 'hep', 'math','physics', 'q-bio', 'q-fin', 'quant', 'stat'], rotation=45, fontsize=16, **hfont)
    plt.yticks(tick_marks, ['astro', 'cond', 'cs', 'hep', 'math','physics', 'q-bio', 'q-fin', 'quant', 'stat'], fontsize=16, **hfont)
    plt.tight_layout()
